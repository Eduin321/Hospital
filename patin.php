...
<br>
<h1 class="text-center ">Hospital San Martin de Porres<br /><small style="font-size:20px">Sistema Administrativo </small></h1></div>
...
<h3 class="panel-title text-center">Formulario Registro de Pacientes</h3>
</div>
<center>
...
document.write('<?php echo $conduperr; ?>');
    ...
    <div class="input-group col-md-12 col-xs-12"><input required name="lname" id="lname"   type="text" class="form-control" placeholder="Nombres y Apellidos">
	</div>
    </td>
  </tr>
<tr>
...
('<?php echo $emlduperr; ?>');</script></td>
  ...
  <tr>
    ...
    <tr>
     <td colspan="2"  style="padding:5px;" >Fecha de nacimiento<div class="input-group col-md-12 col-xs-12"><input min="1900-01-01" max="2022-07-27" step="1" name="smbdd" required  type="date" class="form-control" placeholder="Fecha de nacimiento"></div></td>
  </tr>
