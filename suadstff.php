...
<title>Hospital San Martin de Porres</title>
...
<h1 class="text-center ">Hospital San Martin de Porres<br /><small style="font-size:20px">Hospital Administrativo</small></h1></div>
</div>
</div>
...
<li style="font-family:calibri; font-size:16px;"><a href="supadminopsm.php">Inicio</a></ul>
</div>
</div>
</div>
<br />
...
<form class="" action="" method="post" id="upform">
  ...
  <dt style="font-size:12px;"><strong> No Reg:</strong> </dt>
  <dd style="font-size:12px;"><?php echo $row["staffID"]; ?></dd>

  <dt style="font-size:12px;"><strong>Primer nombre : </strong> </dt>
  ...
  <dt style="font-size:12px;"><strong>Apellido : </strong> </dt>
  ...
  <select name="gen"  id="gen"  style="margin:5px"    class="form-control" placeholder="Select your Gendere">
      ...
      <option value="Female">Femenino</option></dd>
  </select>

  <dt style="font-size:12px;"><strong>Tipo : </strong></dt></dt>
  <dd style="font-size:12px;">
  ...
  <dt style="font-size:12px;"><strong>Tiempo de trabajo: </strong></dt></dt>
  <dd style="font-size:12px;">
  ...
  <dt style="font-size:12px;"><strong>Contacto : </strong>
...
<dl>
  <dt style="font-size:12px;"><strong>Habilite campo para modificar: </strong></dt></dt>
  <dd style="font-size:12px;">
  ...
  <option value="ED">EHabilitar campos</option>
  </select></dd>
  <input type="hidden" name="id"  value="<?php echo $row["staffID"]; ?>" />
</dl>
  <center>
<button disabled id="Button" class="btn" name=submit type="submit">Actualizar</button>
</center>
  </ul>
