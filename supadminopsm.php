...
<br>
  ...
  <dt style="font-size:12px;"><strong>Ultimo Nombre : </strong> </dt>
  ...
  <dt style="font-size:12px;"><strong>Tipo de miembro del personal: </strong></dt>
      <dd style="font-size:12px;">
      <select  id="gen" disabled style="margin:5px" name="gender" required="required"  class="form-control" placeholder="Select your Gendere">
          ...
          <dt style="font-size:12px;"><strong>Horario: </strong></dt>
          <dd style="font-size:12px;">
          <select  id="gen" disabled style="margin:5px" name="gender" required="required"  class="form-control" placeholder="Select your Gendere">
              <option  value="<?php echo $row["smwoti"]; ?>"><?php echo $row["smwoti"]; ?></option>
              <option value="Morning">Mañana</option>
              <option value="Evening">Tarde</option>
              <option value="Full">Tiempo completo</option></select></dd>
  ...
  <dt style="font-size:12px;"><strong>Celular : </strong>
  ...
  <dt style="font-size:12px;"><strong>Insertado por: </strong></dt>
  ...
  <dt style="font-size:12px;"><strong>fecha de insertado: </strong></dt>
  ...
  <dt style="font-size:12px;"><strong>fecha de actualizacion: </strong></dt>
