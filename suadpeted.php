...
<h3 style="font-family:calibri;" class="text-center">Actualizacion de pacientes</h3></div>
</div>
</div>
</div>
...
<li style="font-family:calibri; font-size:16px;"><a href="supadminop.php">Inicio</a></ul>
</div>
</div>
</div>
<br />
...
<form class="" action="" method="post" id="upform">
  ...
  <dt style="font-size:12px;"><strong>No Registro:</strong> </dt>
...
<dl>
  <dt style="font-size:12px;"><strong>Habilite campos para actualizar: </strong></dt></dt>
  <dd style="font-size:12px;">
