...
<div class="col-md-4 col-md-push-2  col-xs-12 ">
	...
	<div class="input-group input-group-lg"><span class="input-group-addon"><img style="width:30px" src="images/log/user.png" /></span>
	  <input pattern="\d{,}"  maxlength="20" name="sadmun" required="required" style=" height:52px; font-size:20px" id="field" type="text" class="form-control " placeholder="Usuario">
	...
	<div style="font-size :18px; border-style: none  none none dotted; border-width: 2px; border-color: rgba(0, 0, 0, 0.2); height: 390px;text-align: justify;" class="col-md-4 col-md-push-2  col-xs-12 "><br>Este es el formulario de inicio de sesión del sistema principal.Si desea iniciar sesion solo se ascedera con el usuario Administrador de todo el sistema. 
<br>
	<br>Ingrese los detalles de inicio de sesión proporcionados por la administración del Hospital San Martin de Porres. </div>
	</div>
