...
<div class="row">
<div class="col-md-12 ">
<h4 style="font-family:calibri;" class="text-center">Al hacer clic en más información se puede obtener el médico asignado, puedes ingresar a un paciente para admitirlo en el hospital.</h4>
<br />
...
<tr valign="middle">
    ...
    <td  align="left"><?php echo $row["pet_fn"]; ?></td>
    <td  align="left"><?php echo $row["pet_sn"]; ?></td>
    <td  align="left"><?php echo $row["Pet_opdid"]?> | Dr.<?php echo $row["smfname"]?> <?php echo $row["smlname"]?> | <a target="_blank" href="admitdf.php?id= <?php echo $row["Pet_opdid"]; ?>" name="ad">  </a> </td>
